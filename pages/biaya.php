                    ...
                    <div class="form-group" style="display:none;" id="barisTetap">
                         <div class="col-sm-8 col-md-offset-2">
                            <select class ="form-control" name="idbiaya" id="idtetap" onchange="FilterGaji();">
                                ...
                                <?php
                                $result=mysql_query("SELECT * FROM biaya where tetap is not null and visible='1' order by nama");
                ...
                <form class="form-horizontal" role="form" action="prosesbiaya.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-xs-4 col-xs-offset-1 ">
                            <?php
                                $result=mysql_query("SELECT sum(total) as total FROM detail_pengeluaran_temp where pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'"); 
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                                <?php
                                    $result = mysql_query("SELECT a.iddetail_pengeluaran_temp as ID, a.keterangan,a.total,a.jenis,b.nama 
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <?php
                                        $no = '0';
                                        $result = mysql_query("SELECT a.iddetail_pengeluaran_temp as ID,a.total,a.jenis,concat(b.nama,' ',a.keterangan) as nama FROM detail_pengeluaran_temp a inner join biaya b on a.biaya_idbiaya=b.idbiaya and b.tetap is not null and a.pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'");
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                                    <?php
                                        ...
                                        $detailpengeluaran_temp = mysql_fetch_array($result);
                                        mysql_free_result($result);
                                        $testperlengkapan = $detailpengeluaran_temp['ID'];
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <?php
                                ...
                                $detailpengeluaran_temp = mysql_fetch_array($result);
                                mysql_free_result($result);
                                $testbelanja = $detailpengeluaran_temp['ID'];
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <?php
                                ...
                                $detailpengeluaran_temp = mysql_fetch_array($result);
                                mysql_free_result($result);
                                $testlain = $detailpengeluaran_temp['ID'];
                                if (!empty($testlain)) {
                            ?>
